	  ...
	  <div class="content-wrapper">
	    ...
	    <section class="content-header">
	      <div class="container-fluid">
	        <div class="row mb-2">
	          <div class="col-sm-6">
	            <h1>Add Photo to ${fabric.name }</h1>
	          </div>
	          <div class="col-sm-6">
	          ...
	          <div class="col-12">
	            <div class="card">
	              <div class="card-body">
				      ...
				      <s:form modelAttribute="photo" enctype="multipart/form-data" action="${pageContext.request.contextPath }/home/admin/photo/add/fabric" method="post">
					      <div class="row">
