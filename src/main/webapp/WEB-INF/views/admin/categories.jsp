	          ...
	          <c:if test="${error != null }">
	            ...
	            <div class="card">
	              <div class="card-header">
	                <a href="${pageContext.request.contextPath}/home/admin/add_category" class="btn btn-success">Add Category</a>
	              </div>
	              <!-- /.card-header -->
	              <div class="card-body">
	                <table id="categoryList" class="table table-bordered table-striped">
	                  ...
	                  <c:forEach var="c" items="${categories }">
		                  <tr>
		                    ...
		                    <td>
		                    	<a href="${pageContext.request.contextPath}/home/admin/edit_category/${c.category_id}">Edit</a> 
		                    	| 
		                    	<a href="${pageContext.request.contextPath}/home/admin/delete_category/${c.category_id}" onclick="return confirm('Are you sure?')">Delete</a>
		                    	|
		                    	<a href="${pageContext.request.contextPath}/home/admin/sub_categories/${c.category_id}">Sub Categories</a>
		                    	|
		                    	<a href="${pageContext.request.contextPath}/home/admin/add_sub_category/${c.category_id}">Add Sub Categories</a> 
		                    </td>
		                  </tr>
	                  </c:forEach>
	                  </tbody>
