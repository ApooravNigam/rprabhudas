	          ...
	          <c:if test="${error != null }">
	            ...
	            <div class="card">
	              <div class="card-header">
	                <a href="${pageContext.request.contextPath}/home/admin/add_company" class="btn btn-success">Add Company</a>
	              </div>
	              <!-- /.card-header -->
	              <div class="card-body">
	                <table id="categoryList" class="table table-bordered table-striped">
	                  ...
	                  <c:forEach var="c" items="${companies }">
		                  <tr>
		                    ...
		                    <td>
		                    	<a href="${pageContext.request.contextPath}/home/admin/edit_company/${c.id}">Edit</a> 
		                    	| 
		                    	<a href="${pageContext.request.contextPath}/home/admin/delete_company/${c.id}" onclick="return confirm('Are you sure?')">Delete</a>
		                    	|
		                    	<a href="${pageContext.request.contextPath}/home/admin/sub_companies/${c.id}">Sub Companies</a>
		                    	|
		                    	<a href="${pageContext.request.contextPath}/home/admin/add_sub_company/${c.id}">Add Sub Companies</a> 
		                    </td>
		                  </tr>
	                  </c:forEach>
	                  </tbody>
