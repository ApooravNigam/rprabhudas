	      ...
	      <div class="container-fluid">
	        <div class="row">
	          <div class="col-12">
	            <div class="card">
	              <div class="card-body">
				      <s:form modelAttribute="category" action="${pageContext.request.contextPath }/home/admin/edit_sub_category" method="post">
				        ...
				        <div class="row">
				          <div class="col-12">
			            	...
			            	<s:hidden path="category.category_id"/>
			            	<s:hidden path="category_id"/>
				          </div>
				          <!-- /.col -->
				        </div>
				      </s:form>
