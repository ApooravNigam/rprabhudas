	  ...
	  <div class="content-wrapper">
	    ...
	    <section class="content-header">
	      <div class="container-fluid">
	        <div class="row mb-2">
	          <div class="col-sm-6">
	            <h1>Sub Companies of ${company.name }</h1>
	          </div>
	          <div class="col-sm-6">
	            <ol class="breadcrumb float-sm-right">
	              <li class="breadcrumb-item"><a href="#">Home</a></li>
	              <li class="breadcrumb-item active">Sub Companies</li>
	            </ol>
	          </div>
	        </div>
	      </div><!-- /.container-fluid -->
	            ...
	            <div class="card">
	              ...
	              <div class="card-body">
	                <table id="categoryList" class="table table-bordered table-striped">
	                  ...
	                  <tbody>
	                  <c:forEach var="c" items="${company.companies }">
		                  <tr>
		                    <td>${c.id }</td>
		                    <td>${c.name }</td>
		                    <td>${c.status ? 'Show' : 'Hide' }</td>
		                    <td>
		                    	<a href="${pageContext.request.contextPath}/home/admin/edit_sub_company/${c.id}">Edit</a> 
		                    	| 
		                    	<a href="${pageContext.request.contextPath}/home/admin/delete_sub_company/${c.id}" onclick="return confirm('Are you sure?')">Delete</a>
		                    </td>
		                  </tr>
	                  </c:forEach>
	                  </tbody>
