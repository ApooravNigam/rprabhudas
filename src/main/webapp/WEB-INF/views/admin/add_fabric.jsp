				      ...
				      <s:form modelAttribute="fabric" action="${pageContext.request.contextPath }/home/admin/add_fabric" method="post">
					    <div class="row">
					        <div class="col-md-3 col-sm-12 form-group">
					          <label>Company</label>
					          <s:select id="company" name="company_id" path="company.id" class="form-control">
					        ...
					        <div class="col-md-3 col-sm-12 form-group">
					          ...
					          <s:select id="sub_company" name="sub_company_id" path="sub_company_id" class="form-control">
		                          
		                      </s:select>
					        </div>
					        <div class="col-md-3 col-sm-12 form-group">
					          <label>Quality Construction</label>
					          <s:input path="name" name="name" cssClass="form-control" id="name" required="required"/>
					        </div>
					        <div class="col-md-3 col-sm-12 form-group">
					          <label>Quality Number</label>
					          <s:input path="quality_number" name="quality_number" cssClass="form-control" id="quality_number" required="required"/>
					        </div>
					        <div class="col-md-3 col-sm-12 form-group">
					          <label>SKU</label>
	...
	$(document).ready(function(){
	    ...
	    $("#company").change(function(){
		    ...
		    $.ajax({
		        type: 'GET',
		        dataType: "json",
		        url: "${pageContext.request.contextPath }/home/admin/get_sub_companies/" + company_id,
		        success:function(data){
		        	var sub_company;
		        	for (var i = 0; i < data.length; i++) {
		        		sub_company += "<option value='" + data[i].id + "'>" + data[i].name + "</option>";
		        	}
		        	$("#sub_company").html(sub_company);
		        }
		    });
		/* return false; */
		});
