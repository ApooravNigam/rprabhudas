	          ...
	          <div class="col-12">
	            <div class="card">
	              <div class="card-body">
				      ...
				      <s:form modelAttribute="colors" action="${pageContext.request.contextPath }/home/admin/add_color" method="post">
					      <div class="row">
					        ...
					        <div class="col-md-6 col-sm-12 form-group">
					          ...
					          <s:input type="color" path="color_code" name="color_code" cssClass="form-control" id="color_code" required="required"/>
					        </div>
				        </div>
				        <div class="row">
				          <div class="col-3">
