	  ...
	  <div class="content-wrapper">
	    ...
	    <section class="content-header">
	      <div class="container-fluid">
	        <div class="row mb-2">
	          <div class="col-sm-6">
	            <h1>Add Sub Company to ${company.company.name }</h1>
	          </div>
	          <div class="col-sm-6">
	      ...
	      <div class="container-fluid">
	        <div class="row">
	          <div class="col-12">
	            <div class="card">
	              <div class="card-body">
				      <s:form modelAttribute="company" action="${pageContext.request.contextPath }/home/admin/add_sub_company" method="post">
