	          ...
	          <div class="col-12">
	            <div class="card">
	              <div class="card-header">
	                <a href="${pageContext.request.contextPath}/home/admin/add_color" class="btn btn-success">Add Color</a>
	              </div>
	              <!-- /.card-header -->
	              <div class="card-body">
	                <table id="colorList" class="table table-bordered table-striped">
	                  ...
	                  <c:forEach var="c" items="${colors }">
		                  <tr>
		                    ...
		                    <td>${c.color_code }</td>
		                    <td>
		                    	<a href="${pageContext.request.contextPath}/home/admin/edit_color/${c.id}">Edit</a> 
		                    	| 
		                    	<a href="${pageContext.request.contextPath}/home/admin/delete_color/${c.id}" onclick="return confirm('Are you sure?')">Delete</a>
		                    </td>
		                  </tr>
	                  </c:forEach>
	                  </tbody>
