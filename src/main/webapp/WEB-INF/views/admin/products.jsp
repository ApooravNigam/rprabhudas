	          ...
	          <c:if test="${error != null }">
	            ...
	            <div class="card">
	              <div class="card-header">
	                <a href="${pageContext.request.contextPath}/home/admin/add_product" class="btn btn-success">Add Product</a>
	              </div>
	              <!-- /.card-header -->
	              <div class="card-body">
	                <table id="categoryList" class="table table-bordered table-striped">
	                  ...
	                  <c:forEach var="c" items="${products }">
		                  <tr>
		                    ...
		                    <td>
		                    	<a href="${pageContext.request.contextPath}/home/admin/edit_product/${c.id}">Edit</a> 
		                    	| 
		                    	<a href="${pageContext.request.contextPath}/home/admin/delete_product/${c.id}" onclick="return confirm('Are you sure?')">Delete</a>
		                    	|
		                    	<a href="${pageContext.request.contextPath}/home/admin/photo/products/${c.id}">Photos</a>
		                    	|
		                    	<a href="${pageContext.request.contextPath}/home/admin/photo/add/products/${c.id}">Add Photo</a> 
		                    </td>
		                  </tr>
	                  </c:forEach>
	                  </tbody>
