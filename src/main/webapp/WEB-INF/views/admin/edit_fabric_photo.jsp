	  ...
	  <div class="content-wrapper">
	    ...
	    <section class="content-header">
	      <div class="container-fluid">
	        <div class="row mb-2">
	          <div class="col-sm-6">
	            <h1>Edit Photo of ${photo.fabric.name }</h1>
	          </div>
	          <div class="col-sm-6">
	          ...
	          <div class="col-12">
	            <div class="card">
	              <div class="card-body">
				      ...
				      <s:form modelAttribute="photo" enctype="multipart/form-data" action="${pageContext.request.contextPath }/home/admin/photo/edit/fabric" method="post">
					      <div class="row">
					        <div class="col-md-6 col-sm-12 form-group">
					          <label>File</label>
					          <input type="file" name="file" id="file"/>
					          <br>
					          <img alt="${photo.name}" src="${pageContext.request.contextPath}/uploads/images/${photo.name}" width="100" height="100"/>
					        </div>
				          <div class="col-3">
